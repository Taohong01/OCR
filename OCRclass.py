...
class OCR(object):
    """This class is for Optical Character Recognization:
        It is to compare different machine learning models and do parameter
        optimization.
    """
    def __init__(self):
        """initialize various parameters for OCR, including image samples
        some machine learning models etc. 
        """
        ...
        self.svm_params = dict( kernel_type = cv2.SVM_LINEAR,
    ...
    def imageloading():
        ...
        self.train_cells = [ i[:50] for i in cells ]
        self.test_cells = [ i[50:] for i in cells]
